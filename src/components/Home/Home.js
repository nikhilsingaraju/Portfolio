    ...
    <div className='mt-4'>
      <div className="row row-1 ">
        ...
        <div className="col-12 col-md-6 column-1">
          ...
          <h1 className='heading'>Nikhil Singaraju</h1>
          ...
          <div>
            ...
            <div className="d-flex justify-content-between w-50 pb-4">
              <Social site="gmail" gmail="nikhil.singaraju5@gmail.com" />
          ...
          <div className='mb-5'>
            <a className='myBtnLink' target="_blank" rel="noreferrer" href='https://github.com/nikhilsingaraju?tab=repositories'>
